...
namespace Geet.Classes
{
    public partial class FrmVenda : Form
    {
        ...
        private void FrmVenda_Load(object sender, EventArgs e)
        {
            ...
            btnFinalizarVendas.Enabled = false;
        ...
        private void btnNovoPedido_Click(object sender, EventArgs e)
        {
            ...
            btnFinalizarVendas.Enabled = true;
        ...
        private void btnNovoItem_Click(object sender, EventArgs e)
        {
            ...
            if (repetido == false)
            {
                ...
                item.Cells[2].Value = txtQuantidades.Text;
                item.Cells[3].Value = txtValor.Text;
                item.Cells[4].Value = Convert.ToDecimal(txtValor.Text) * Convert.ToDecimal(txtQuantidades.Text);
        ...
        private void btnEditarItem_Click(object sender, EventArgs e)
        {
            ...
            dgvPedido.Rows[linha].Cells[2].Value = txtQuantidades.Text;
            dgvPedido.Rows[linha].Cells[3].Value = txtValor.Text;
            dgvPedido.Rows[linha].Cells[4].Value = Convert.ToDecimal(txtValor.Text) * Convert.ToDecimal(txtQuantidades.Text);
            txtIdProduto.Text = "";
            txtTotal.Text = "";
            txtQuantidades.Text = "";
            cbxProduto.Text = "";
        ...
        private void btnFinalizarVendas_Click(object sender, EventArgs e)
        {
            try
            {
                if (con.State == ConnectionState.Open)
        ...
        private void dgvPedido_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtQuantidades.Text = row.Cells[2].Value.ToString();
            txtValor.Text = row.Cells[3].Value.ToString();
        }

        private void txtQuantidades_Leave(object sender, EventArgs e)
        {
            if (con.State == ConnectionState.Open)
            {
                con.Close();
            ...
            SqlDataReader dr = cmd.ExecuteReader();
            int valor1 = 0;
            bool conversaoSucedida = int.TryParse(txtQuantidades.Text, out valor1);
            if (dr.Read())
            {
        ...
        private void AtualizarCorEstoque()
        {
            int estoqueAtual;

            if (int.TryParse(lblEstoque.Text, out estoqueAtual))
            {
                int estoqueBaixo = 50;
                int estoqueMetade = 150;

                if (estoqueAtual <= estoqueBaixo)
                {
                    lblEstoque.ForeColor = Color.Red;
                }
                else if (estoqueAtual <= estoqueMetade)
                {
                    lblEstoque.ForeColor = Color.Yellow;
                }
                else
                {
                    lblEstoque.ForeColor = Color.Green;
                }
            }
            else
            {
                lblEstoque.ForeColor = Color.Gray; // ou qualquer outra cor que indique um estado inválido
            }
        }
    }
}